  ...
  methods: {
    ...
    term() {
      return new Promise(resolve => {
        ...
        <p class="p-2">・特にお店の場所は<a href="https://newspat.csis.u-tokyo.ac.jp/geocode/modules/dams/index.php?content_id=1" class="underline">使用しているジオコーダ(DAMS)</a>の都合上、おおよその位置しか表示できません。
          </strong><strong>必ずGoogleMapなど、他サービスも合わせてご確認ください。</strong></p>
